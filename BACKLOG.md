...
- [ ] **DOZN Score Calibration** — Our 0-10 scores diverge significantly from DOZN's 0-100 scores on the same protocol. Need to understand DOZN's formulas (Sami may share), calibrate our scoring to produce comparable results, or at minimum document the mapping between the two systems. Critical for Merck credibility. [added::2026-04-03]
